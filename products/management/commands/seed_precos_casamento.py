"""
Popula os preços por estado para Certidão de Casamento 2ª Via.

Uso:
    python manage.py seed_precos_casamento
    python manage.py seed_precos_casamento --reset
"""
from django.core.management.base import BaseCommand, CommandError

from products.models import Product, State, ServiceStatePrice
from products.services import PRECOS_CERTIDAO_CASAMENTO

SLUG_CASAMENTO = "certidao-de-casamento-2a-via"


class Command(BaseCommand):
    help = "Popula preços por estado para Certidão de Casamento 2ª Via"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--slug",
            default=SLUG_CASAMENTO,
            help=f"Slug do produto (padrão: {SLUG_CASAMENTO})",
        )
    ...
    def handle(self, *args, **options):
        ...
        for code, preco in PRECOS_CERTIDAO_CASAMENTO.items():
            try:
