"""
Popula os preços por estado para Certidão de Interdição.

Uso:
    python manage.py seed_precos_interdicao
    python manage.py seed_precos_interdicao --reset
"""
from django.core.management.base import BaseCommand, CommandError

from products.models import Product, State, ServiceStatePrice
from products.services import PRECOS_CERTIDAO_INTERDICAO

SLUG_INTERDICAO = "certidao-de-interdicao"


class Command(BaseCommand):
    help = "Popula preços por estado para Certidão de Interdição"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--slug",
            default=SLUG_INTERDICAO,
            help=f"Slug do produto (padrão: {SLUG_INTERDICAO})",
        )
    ...
    def handle(self, *args, **options):
        ...
        for code, preco in PRECOS_CERTIDAO_INTERDICAO.items():
            try:
