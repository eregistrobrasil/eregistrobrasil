"""
Popula os preços por estado para Certidão de Nascimento 2ª Via.

Uso:
    python manage.py seed_precos_nascimento
    python manage.py seed_precos_nascimento --reset  # reescreve todos os preços
"""
from django.core.management.base import BaseCommand, CommandError

from products.models import Product, State, ServiceStatePrice
from products.services import PRECOS_CERTIDAO_NASCIMENTO

# Slug do produto — ajuste se necessário
SLUG_NASCIMENTO = "certidao-de-nascimento-2a-via"


class Command(BaseCommand):
    help = "Popula preços por estado para Certidão de Nascimento 2ª Via"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--slug",
            default=SLUG_NASCIMENTO,
            help=f"Slug do produto (padrão: {SLUG_NASCIMENTO})",
        )
    ...
    def handle(self, *args, **options):
        ...
        for code, preco in PRECOS_CERTIDAO_NASCIMENTO.items():
            try:
