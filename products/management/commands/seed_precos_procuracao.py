"""
Popula os preços por estado para Certidão de Procuração.

Uso:
    python manage.py seed_precos_procuracao
    python manage.py seed_precos_procuracao --reset   # reescreve todos os preços
    python manage.py seed_precos_procuracao --slug=outro-slug
"""
from django.core.management.base import BaseCommand, CommandError

from products.models import Product, State, ServiceStatePrice
from products.services import PRECOS_CERTIDAO_PROCURACAO

SLUG_PROCURACAO = "certidao-de-procuracao"


class Command(BaseCommand):
    help = "Popula preços por estado para Certidão de Procuração"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--slug",
            default=SLUG_PROCURACAO,
            help=f"Slug do produto (padrão: {SLUG_PROCURACAO})",
        )
    ...
    def handle(self, *args, **options):
        ...
        for code, preco in PRECOS_CERTIDAO_PROCURACAO.items():
            try:
