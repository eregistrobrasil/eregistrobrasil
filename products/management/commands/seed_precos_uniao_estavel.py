"""
Popula os preços por estado para Certidão de Escritura de União Estável.

Uso:
    python manage.py seed_precos_uniao_estavel
    python manage.py seed_precos_uniao_estavel --reset
    python manage.py seed_precos_uniao_estavel --slug=outro-slug
"""
from django.core.management.base import BaseCommand, CommandError

from products.models import Product, State, ServiceStatePrice
from products.services import PRECOS_CERTIDAO_UNIAO_ESTAVEL

SLUG_UNIAO_ESTAVEL = "certidao-de-escritura-de-uniao-estavel"


class Command(BaseCommand):
    help = "Popula preços por estado para Certidão de Escritura de União Estável"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--slug",
            default=SLUG_UNIAO_ESTAVEL,
            help=f"Slug do produto (padrão: {SLUG_UNIAO_ESTAVEL})",
        )
    ...
    def handle(self, *args, **options):
        ...
        for code, preco in PRECOS_CERTIDAO_UNIAO_ESTAVEL.items():
            try:
